...
\hypersetup{
  pdftitle={TA Session of Econometrics 2 (Oct 2020 - Jan 2021)},
...
\DataTypeTok{coef =} \KeywordTok{list}\NormalTok{(}\KeywordTok{coef}\NormalTok{(ols), b\_fgls, b\_loop, }\KeywordTok{coef}\NormalTok{(gls\_esti)), }
\DataTypeTok{se =} \KeywordTok{list}\NormalTok{(se\_hac, se\_fgls, se\_loop, se\_byR),}
\DataTypeTok{t =} \KeywordTok{list}\NormalTok{(t\_hac, t\_fgls, t\_loop, t\_byR), }
\DataTypeTok{p =} \KeywordTok{list}\NormalTok{(p\_hac, p\_fgls, p\_loop, p\_byR),}
\DataTypeTok{t.auto =} \OtherTok{FALSE}\NormalTok{, }\DataTypeTok{p.auto =} \OtherTok{FALSE}\NormalTok{,}
...
\DataTypeTok{add.lines =} \KeywordTok{list}\NormalTok{(}
    ...
    \KeywordTok{c}\NormalTok{(}\StringTok{"R{-}Squared"}\NormalTok{, }\KeywordTok{round}\NormalTok{(ols\_summary}\OperatorTok{$}\NormalTok{r.squared, }\DecValTok{4}\NormalTok{), }\KeywordTok{round}\NormalTok{(R2\_fgls, }\DecValTok{4}\NormalTok{), }
        \KeywordTok{round}\NormalTok{(R2\_loop, }\DecValTok{4}\NormalTok{), }\KeywordTok{round}\NormalTok{(R2\_byR, }\DecValTok{4}\NormalTok{))}
\NormalTok{),}
...
{\centering \includegraphics[width=0.9\linewidth]{Econometrics2TA_files/figure-latex/TimeSeriesPlot-1} 
...
In \texttt{R}, the library calles \texttt{astsa} provides a function to estimate AR(p) model, named \texttt{sarima()}.
...
we specify \texttt{p\ =\ 1}, \texttt{q\ =\ 0}, \texttt{d\ =\ 0}, and \texttt{no.constant\ =\ TRUE}.
The R snippet is as follows:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ar1 \textless{}{-}}\StringTok{ }\KeywordTok{sarima}\NormalTok{(dt}\OperatorTok{$}\NormalTok{close\_price, }\DataTypeTok{p =} \DecValTok{1}\NormalTok{, }\DataTypeTok{q =} \DecValTok{0}\NormalTok{, }\DataTypeTok{d =} \DecValTok{0}\NormalTok{, }\DataTypeTok{no.constant =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{sprintf}\NormalTok{(}
  \StringTok{"The estimated beta is \%1.5f (s.e. = \%1.5f)"}\NormalTok{, }
\NormalTok{  ar1}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{coef, }\KeywordTok{sqrt}\NormalTok{(ar1}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{var.coef)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sprintf}\NormalTok{(}\StringTok{"The estimated squared sigma is \%1.2f"}\NormalTok{, ar1}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{sigma2)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.9\linewidth]{Econometrics2TA_files/figure-latex/TimeSeriesPlot2-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ar2 \textless{}{-}}\StringTok{ }\KeywordTok{sarima}\NormalTok{(dt}\OperatorTok{$}\NormalTok{log\_return, }\DataTypeTok{p =} \DecValTok{1}\NormalTok{, }\DataTypeTok{q =} \DecValTok{0}\NormalTok{, }\DataTypeTok{d =} \DecValTok{0}\NormalTok{, }\DataTypeTok{no.constant =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{sprintf}\NormalTok{(}
  \StringTok{"The estimated beta is \%1.5f (s.e. = \%1.5f)"}\NormalTok{, }
\NormalTok{  ar2}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{coef, }\KeywordTok{sqrt}\NormalTok{(ar2}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{var.coef)}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{sprintf}\NormalTok{(}\StringTok{"The estimated squared sigma is \%1.4f"}\NormalTok{, ar2}\OperatorTok{$}\NormalTok{fit}\OperatorTok{$}\NormalTok{sigma2)}
\end{Highlighting}
\end{Shaded}
