...
Note that there is no meaning in order.
...
```{r laborData, eval = FALSE, purl = FALSE, echo = FALSE}
...
```{r truncMle, eval = FALSE, purl = FALSE, echo = FALSE}
whrs <- dt$whrs
...
```{r truncreg, eval = FALSE, purl = FALSE, echo = FALSE}
library(truncreg)
...
```{r tab_truncate, results = "asis", eval = FALSE, purl = FALSE, echo = FALSE}
