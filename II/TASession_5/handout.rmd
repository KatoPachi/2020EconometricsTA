...
First way is to define the log-likelihood function directly and minimize its function by `nlm` function.
We need to give intial values in argument of this function.
As intial values, coefficients of explanatory variables, `b[2:4]`, are zero, 
and intercept, denoted by `b[2]`, are given by mean of `trips`.
...
Alotough the size of coeffcients of OLSE is farther away from zero than coefficients of the Poisson regression,
the sign of coeffcients of OLSE is same as coefficients of the Poisson regression.
