...
The sample size of this data is two thirs of total observations.
We use the training data (*in-sample*) to estimate and evaluate model fitness.
The test data consists of observations which the training data does not include.
...
we can use this command safely.
